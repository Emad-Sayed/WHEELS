                                        ...
                                        <tr>
                                            <td>
                                                <span class="glyphicon glyphicon-pencil text-primary"></span><a
                                                    href="/#/dashboard/addCar">Add Car</a>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>
                                                <span class="glyphicon glyphicon-pencil text-primary"></span><a
                                                    href="/#/dashboard/addCategory">Add Category</a>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>
                            ...
                            <div id="collapseTwo" class="panel-collapse collapse">
                                <div class="panel-body">
                                    <table class="table">
                                        <tr>
                                            <td>
                                                <a href="/#/dashboard/carsTable">Cars</a>
                                                <span class="label label-success">$ 320</span>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>
                                                <a href="/#/dashboard/categoriesTable">Categories</a>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>
                                                <a href="/#/dashboard/rentedCars">RentedCars</a>
                                            </td>
                                        </tr>
                                    </table>
                                </div>
...
<script>
    import {GetHeaders,isAdmin} from '../../config'
    export default{
        ...
        methods: {
            updateCarsStatus(){
                axios.get('api/updateStatus', {headers: GetHeaders()})
                    .then(response => {
                    })
            }
        },
